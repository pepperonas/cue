...
**Download:** die signierte APK hängt am jeweils neuesten
[`android-v*`-Release](https://github.com/pepperonas/cue/releases?q=android-v&expanded=true)
(aktuell 0.1.0). Nach der Installation in der Web-App unter
**Einstellungen → Geräte** ein Gerät anlegen und Server-Adresse + Token in der
App einfügen.
