...
<!-- hero:dynamic -->
[![version](https://img.shields.io/badge/version-v0.73.0-7c5cff.svg?style=for-the-badge&labelColor=1a1c22)](CHANGELOG.md)
[![lines of code](https://img.shields.io/badge/lines%20of%20code-38%20872-0A9EDC.svg?style=for-the-badge&labelColor=1a1c22)](#)
<!-- /hero:dynamic -->

</div>

<!-- badges:dynamic -->
[![tests](https://img.shields.io/badge/tests-1635%20passing-brightgreen.svg)](docs/TESTING.md)
[![backend tests](https://img.shields.io/badge/backend%20tests-684-brightgreen.svg)](backend/tests/)
[![runner tests](https://img.shields.io/badge/runner%20tests-130-brightgreen.svg)](cue-runner/tests/)
[![frontend tests](https://img.shields.io/badge/frontend%20tests-759-brightgreen.svg)](frontend/src/lib/)
[![script tests](https://img.shields.io/badge/script%20tests-62-brightgreen.svg)](scripts/tests/)
[![test files](https://img.shields.io/badge/test%20files-81-0A9EDC.svg)](docs/TESTING.md)
...
[![test LOC](https://img.shields.io/badge/test%20LOC-16%20783-0A9EDC.svg)](docs/TESTING.md)
...
[![Python LOC](https://img.shields.io/badge/Python%20LOC-12%20644-3776AB.svg)](#)
[![TypeScript LOC](https://img.shields.io/badge/TypeScript%20LOC-21%20244-3178C6.svg)](#)
[![CSS LOC](https://img.shields.io/badge/CSS%20LOC-4%20984-663399.svg)](#)
[![source files](https://img.shields.io/badge/source%20files-180-blue.svg)](#)
[![pure lib modules](https://img.shields.io/badge/pure%20lib%20modules-42-3178C6.svg)](frontend/src/lib/)
[![React components](https://img.shields.io/badge/React%20components-55-61DAFB.svg)](frontend/src/components/)
[![React hooks](https://img.shields.io/badge/React%20hooks-96-61DAFB.svg)](frontend/src/state/)
[![API endpoints](https://img.shields.io/badge/API%20endpoints-107-8A2BE2.svg)](docs/API.md)
[![routers](https://img.shields.io/badge/routers-16-8A2BE2.svg)](backend/app/routers/)
[![DB tables](https://img.shields.io/badge/DB%20tables-22-003B57.svg)](docs/ARCHITECTURE.md)
[![migrations](https://img.shields.io/badge/migrations-41-003B57.svg)](backend/app/db.py)
[![schemas](https://img.shields.io/badge/schemas-102-009688.svg)](backend/app/schemas.py)
...
[![releases](https://img.shields.io/badge/releases-92-blue.svg)](CHANGELOG.md)
[![last release](https://img.shields.io/badge/last%20release-2026--09--21-blue.svg)](CHANGELOG.md)
...
- **Suche über Prompts, Tags und Projektnamen** — und die **Projekt-Chips oben folgen ihr**: „termst" lässt nur Projekte stehen, die so heißen oder passende Prompts haben. Mit Anführungszeichen (`"termst`) wird **nur in Projektnamen** gesucht — ein Hinweis am Feld erklärt das beim Zeigen (eigener Tooltip statt `title`: sofort da statt nach zwei Sekunden); das öffnende Zeichen genügt, damit die Trefferliste beim Tippen enger wird statt am Ende zu springen. „Ohne Projekt" verschwindet, wenn die Suche dort nichts findet — außer es ist der aktive Filter.
...
- **Prompts als JSON exportieren**: einen im Ansichtsdialog, mehrere über die Auswahlleiste. Ein Umschalter vor dem Knopf wählt das Ziel — **`.json`-Datei** mit automatischem Namen (`cue-<titel>-20260921.json`, bei mehreren `cue-3-prompts-20260921.json`) oder direkt in die **Zwischenablage** — und merkt es sich. Exportiert wird eine **portable** Sicht: das Projekt reist als Name, das Modell im Klartext, Tags als Liste; interne Zähler (Sortierposition, Zusammenführungs-Herkunft, Optimierungs-Version) bleiben draußen. Eine **wartende** KI-Fassung reist als `optimized_body` mit — nur solange sie unentschieden ist, denn nur dann ist der Haupttext nicht der neueste. Vorhandene Screenshots werden beim Namen genannt, aber nicht eingebettet.
- **Import** von `.txt` (Split an `---`/Leerzeilen/keiner) + **Gesamt-Export** des Kontos als JSON-Backup oder ZIP (`.txt` pro Prompt) unter Einstellungen.
...
| --- | --- | --: | --: | --- |
| Backend | `backend/tests/` | 684 | 96 % | HTTP-Verhalten end-to-end gegen echtes tmp-SQLite: Auth/OAuth, Mandantentrennung, CRUD, Runs, Capture, Snippets, CSP |
...
| Frontend | `frontend/src/lib/` | 759 | 95 % | die reinen Module: Markdown-XSS, Tags, Tastenlogik, Titel-Vervollständigung, Sortierung, Live-Sync, Farben |
